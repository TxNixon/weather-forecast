...
function analyzeWeatherTrends(forecast) {
  ...
  return {
    ...
    averageHumidity: (humidity.reduce((a, b) => a + b, 0) / humidity.length).toFixed(1)
  };
}
...
Current weather context: ${weatherData ? JSON.stringify(weatherData, null, 2) : 'No current weather data provided'}
